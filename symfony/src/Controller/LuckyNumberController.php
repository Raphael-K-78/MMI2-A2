...
final class LuckyNumberController extends AbstractController //cr"ation du controleur
{
    #[Route('/number', name: 'app_lucky_number')] //la route et le nom intern a symfony
